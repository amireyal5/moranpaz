  ...
  return (
    <a 
      ...
      className={cn(
        ...
        "bg-[#25D366] text-white p-3.5 sm:p-4 rounded-full shadow-2xl hover:scale-110 transition-all duration-500 group"
      )}
      aria-label="WhatsApp"
    >
      <MessageCircle size={24} className="sm:size-28 group-hover:rotate-12 transition-transform" />
