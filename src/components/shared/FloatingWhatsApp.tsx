  ...
  return (
    <a 
      ...
      className={cn(
        ...
        "bg-slate-400/90 backdrop-blur-sm text-white p-3.5 rounded-full shadow-2xl hover:scale-110 transition-all duration-500 group border border-white/20"
      )}
      aria-label="WhatsApp"
    >
      <WhatsAppIcon size={32} className="group-hover:rotate-12 transition-transform text-slate-500" />
